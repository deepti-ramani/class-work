...
Brief Description:
  This file contains one of the main functions for the array assignment.
  Only compile one at a time and check against the appropriate output, output1.txt in this case.
  Include complier command for both in your array.c file!
